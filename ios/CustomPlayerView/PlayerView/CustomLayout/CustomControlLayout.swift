...
//    }
    ...
    let maasCompactLayoutLine1 = [progressLayoutView]
    let maasCompactLayoutLineDurations = [currentTimeLayoutView,spacerLayoutView, durationLayoutView ]
    let maasCompactLayoutLine2 = [externalRouteLayoutView, spacerLayoutView, rewindButtonLayoutView,spacerLayoutView,playButtonLayoutView,spacerLayoutView,ffButtonLayoutView,spacerLayoutView,rotateButtonLayoutView, screenModeLayoutView]
    let compactLayoutLines = [maasCompactLayoutLine1, maasCompactLayoutLineDurations,[],[], maasCompactLayoutLine2,[]]
